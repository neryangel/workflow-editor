...
import { VariableType, Variable } from '../../types';
        ...
        <>
          ...
          ${isOpen ? 'translate-x-0' : 'translate-x-0'}`}
            ...
            >
                ...
                <span className="text-xs">{variables.length}</span>
            </button>

            {/* Panel */}
            {isOpen && (
                <div className="fixed right-0 top-0 bottom-0 w-80 bg-slate-900 border-l border-slate-700 z-40 flex flex-col">
                    {/* Header */}
                  ...
                  text-white text-sm focus:outline-none focus:ring-1 focus:ring-violet-500"
                    ...
                    hover:border-violet-500/50 transition-colors"
                                    ...
                                    <div className="flex items-start justify-between mb-2">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span
                                                    className={`text-xs px-1.5 py-0.5 rounded border ${getTypeColor(variable.type)}`}
                                                >
                                                    {variable.type}
                                                </span>
                                            </div>
                        ...
                        text-white text-sm focus:outline-none focus:ring-1 focus:ring-violet-500"
                                        ...
                                        <div
                                            className="text-sm text-white font-mono bg-slate-900 px-2 py-1 rounded
                    ...
                    {/* Set Manager Modal */}
                    {showSetManager && (
                        <div className="absolute inset-0 bg-black/50 z-45 flex items-center justify-center p-4">
