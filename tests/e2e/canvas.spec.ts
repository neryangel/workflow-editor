...
test.describe('Canvas Interaction', () => {
    ...
    test('should create a node via sidebar interaction', async ({ page }) => {
        ...
        const nodeButton = page
            .locator('button:has-text("Text"), [data-testid*="text"], [class*="text-input"]')
            .first();
    ...
    test('should pan the canvas', async ({ page }) => {
        ...
        void (await viewport.getAttribute('transform')); // Initial transform captured for debugging
        ...
        void (await viewport.getAttribute('transform')); // New transform captured for debugging
